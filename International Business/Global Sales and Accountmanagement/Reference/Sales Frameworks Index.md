...
aliases: [Sales Frameworks Index, Frameworks index]
---

# Sales Frameworks Index

Which frameworks this course actually requires. [[00 Global Sales and Accountmanagement MOC|↩ MOC]]

> [!warning] The brief requires frameworks the course has not yet supplied
> The assignment says the recommendation must be *"based on the theories and frameworks introduced in the various lectures"* — and **no lecture material is published on Brightspace**. Until the decks appear, this index records what the **rubric** demands and where each requirement can be met from frameworks you already have in the vault.
>
> **This is the first thing to raise with Chiel van Dijk.** The frameworks are a graded requirement, and using the wrong ones is a risk you cannot manage without the decks.

## What the rubric demands, and what meets it
| Rubric requirement | Framework needed | Already in the vault |
|---|---|---|
...
| **Account management** recommendation | Key account planning; channel and customer strategy | [[Account Strategy]] |
| **Data-driven decisions** | Market data, segmentation, and objective alignment | [[Data-Driven Commercial Decisions]] · [[Top Customer Segment]] |
...
**Negotiation** — distributive vs integrative bargaining · BATNA and ZOPA · concession strategy · negotiating across cultures
**Account management** — key account classification and selection · the account plan · customer lifecycle · customer lifetime value · retention and churn
**Steering the function** — sales organisation and territory design · CRM · funnel and pipeline management · forecasting · sales KPIs and targets · remuneration and incentives · sales ethics

When lecture decks land, these become concept notes and this section shrinks.
